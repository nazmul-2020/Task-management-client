  ...
  return (
    <div className="our-speciality px-2 md:px-16">
      <div className="see-more  py-4 mr-14 flex items-center justify-end">
        <Link to="/allFruits" className="flex items-center hover:text-info">
          <p className="pr-3 text-xl">All Fruits </p>
          <FaArrowRight />
        </Link>
      </div>
      <h1 className="text-center text-5xl w-full my-5 font-bold text-info bottom-title relative">
        Our Specialty
      </h1>
      <div className="h-1 bg-info w-1/5 mx-auto opacity-30 my-4"></div>

      <div className="food-content grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-5">
